...
export default function createDomRefs() {
  return {
    ...
    settingsCameraPreview: getRequiredElement("settingsCameraPreview"),
    ...
    operatorAccessHotspot: getRequiredElement("operatorAccessHotspot"),
    navTakeNewButton: getRequiredElement("navTakeNewButton"),
    navLibraryButton: getRequiredElement("navLibraryButton"),
    navInstructionsButton: getRequiredElement("navInstructionsButton"),
    navSettingsButton: getRequiredElement("navSettingsButton"),
    ...
    operatorStandaloneTitle: getRequiredElement("operatorStandaloneTitle"),
    ...
    galleryDialogBody: getRequiredElement("galleryDialogBody"),
    ...
    galleryBusyIndicator: getRequiredElement("galleryBusyIndicator"),
    galleryBusyLabel: getRequiredElement("galleryBusyLabel"),
    galleryList: getRequiredElement("galleryList"),
    galleryVideosLayout: getRequiredElement("galleryVideosLayout"),
    galleryPreviewShell: getRequiredElement("galleryPreviewShell"),
    galleryPreviewStage: getRequiredElement("galleryPreviewStage"),
    galleryPreviewVideo: getRequiredElement("galleryPreviewVideo"),
    galleryPreviewEmpty: getRequiredElement("galleryPreviewEmpty"),
    galleryPreviewPlayButton: getRequiredElement("galleryPreviewPlayButton"),
    galleryPreviewPlayIcon: getRequiredElement("galleryPreviewPlayIcon"),
    galleryPreviewPlayLabel: getRequiredElement("galleryPreviewPlayLabel"),
    galleryPreviewStopButton: getRequiredElement("galleryPreviewStopButton"),
    ...
    settingsCameraFrame: getRequiredElement("settingsCameraFrame"),
    settingsCameraText: getRequiredElement("settingsCameraText"),
    settingsEditorPreviewStage: getRequiredElement("settingsEditorPreviewStage"),
    settingsEmptyCamera: getRequiredElement("settingsEmptyCamera"),
